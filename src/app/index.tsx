  ...
  return (
    <ScrollView style={globalStyles.blackColor} className='flex-1 grid-flow-col pt-[20px]' >
      ...
      <View className='w-full flex-row justify-center gap-[1%]'>
        ...
        <View style={globalStyles.purpleColor} className='flex-[55%] p-[10px] items-center justify-center ml-[5%] min-h-[200px] rounded-md '>
        ...
        <View style={globalStyles.grayColor} className='flex-[25%] p-[10px] rounded-md min-h-[400px]   max-h-fit  mr-[5%]'>
          ...
          <View className='w-full gap-[15px] flex-col items-center'>
            <LoginInput keyboardType="email-address" placeholder='Email. Ex(user@gmail)' title='Email' />
            <LoginInput keyboardType="password" placeholder='Senha/Password' title='Senha' />

            {/* Button */}
            <View className='mt-[30px]'>
              <Pressable style={[globalStyles.purpleButton]} className='w-[160px] p-[20px] rounded-md items-center transition-all duration-200 hover:rotate-6 
              active:p-[22] '><Text selectable={false} style={[globalStyles.JetBrainsFont, globalStyles.whiteFonts]}>Entrar</Text></Pressable>
            </View>
            {/* cadastro/cadaster */}
            <View className='w-full justify-center flex-row items-center'>
              <Text selectable={false} style={[globalStyles.JetBrainsFont, globalStyles.smallFont, globalStyles.whiteFonts]}>Não possui conta? <Pressable className='group/cadastro'><Text className='group-hover/cadastro:text-[19px] group-hover/cadastro:ml-[7px] transition-all duration-200 '>Faça seu cadastro</Text></Pressable></Text>
            </View>
          </View>
        </View>
      </View>
